...
<body>
	...
	<div >
		...
		<form method="post" action="../../db/usuario/update-prepared-mysqli-oo-where-Admin2.php?id=<?php echo $_GET["id"];?>">
			<p>Nome: <input type="text" name="txtNome" value="<?php echo $_GET["nome"] ;?>" required></p>
			<p>Login: <input type="text" name="txtLogin" value="<?php echo $_GET["login"]; ?>" required></p>
